      ...
      <header className="bg-gray-800 border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-white">Streaming Studio</h1>
              <p className="text-gray-400 text-sm mt-1">
                Create and manage your live streaming events
              </p>
            </div>
            <Button
              variant="outline"
                ...
                {!isStreamReady ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4 bg-gray-700/50 rounded-lg space-y-3">
                      ...
                      <div>
                        <label className="text-sm text-gray-400">RTMP URL</label>
                      ...
                      <div>
                        <label className="text-sm text-gray-400">Playback URL (HLS)</label>
                        <div className="flex mt-1">
                          <Input
                    ...
                    <div className="p-4 bg-blue-900/20 border border-blue-700 rounded-lg">
                      <h4 className="text-blue-400 font-medium mb-2">OBS Studio Setup</h4>
